          ...
          <ol className="grid min-w-[1300px] grid-cols-4 gap-5">
            {items.map((item, index) => (
              <li key={item.id} className="min-w-0">
                ...
                >
                  <div className="bg-muted relative aspect-[16/10] min-h-[260px] overflow-hidden">
                    <img
                      src={item.imageSrc}
                      alt={item.imageAlt}
                      width={600}
                    ...
                    <span className="absolute right-3 bottom-3 rounded-full bg-white/88 px-2 py-1 font-mono text-[11px] font-semibold tracking-[0.14em] text-slate-700 shadow-sm backdrop-blur-sm dark:bg-slate-950/65 dark:text-white/90">
