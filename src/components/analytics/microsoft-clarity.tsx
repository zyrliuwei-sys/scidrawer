const CLARITY_PROJECT_ID = 'y0fbg55ov6';

// Load the Clarity tag asynchronously so session recording never blocks the
// page's critical render path. React hoists async scripts into <head>.
